const callbackForm = document.querySelector('.collback-form-container');
const requestResievedModal = document.querySelector('#request-received');
...
callbackForm.addEventListener('submit', function(event){
    ...
    requestResievedModal.classList.add('modal-active');

    setTimeout(function() {
        requestResievedModal.classList.remove('modal-active');
    }, 2000);
});
